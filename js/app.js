...
pHealth.innerHTML =
    '<p>LIVES: <span id="lives"><img class="hearts" src="images/Heart2.png"><img class="hearts" src="images/Heart2.png"><img class="hearts" src="images/Heart2.png"></span></p>';
...
pScore.innerHTML = '<p>SCORE: <span type="number" id="score">00000</span></p>';
...
Entities.prototype.checkCollisions = function(x, y) {
    ...
    allEnemies.forEach(enemy => {
        ...
        if (
            pTop <= eBottom &&
            pBottom - player.sx >= eTop &&
            pLeft + player.sx <= eRight &&
            pRight - player.sx >= eLeft
        ) {
            ...
            if (gameData.livesLeft === 0) {
                ...
                // select the h1 tag
                let header = document.getElementsByClassName("modal")[0]
                    .firstElementChild;
                ...
                message.innerHTML = `
                <p>You made it to <strong>Level ${this.lvl}</strong></p> 
                <p><strong>${gameData.gems} gem(s)</strong> and <strong>${gameData.key} key(s) collected</strong> </p>
                <p>Total Score = <strong>${gameData.score} points</strong>!</p>
            ...
            if (gameData.livesLeft > 0) {
                ...
                if (gameData.livesLeft === 0) {
                    document
                        ...
                        .insertAdjacentHTML(
                            "afterEnd",
                            "<p class='warning'>Uh Oh! Last Life!</p>"
                        );
                }
            }
    ...
    treasure.forEach((loot, idx) => {
        ...
        if (
            pTop <= tBottom &&
            pBottom - player.sx >= tTop &&
            pLeft + player.sx <= tRight &&
            pRight - player.sx >= tLeft
        ) {
...
class Player extends Entities {
    ...
    constructor(sprite = "images/char-boy.png", x = 220, y = 469) {
        ...
        this.collisionSfx = new Audio(
            "soundfx/cartoon-ouch-sound-effect-J0EbCeXN-clipped.mp3"
        );
    }
}
...
class Loot extends Entities {
    ...
    constructor(sprite, x, y, sx, sy, sWidth, sHeight, dx, dy, dWidth, dHeight) {
        ...
        this.getGemSfx = new Audio(
            "soundfx/36365__matiasromero__clareira-sininho.mp3"
        );
        // create new Audio object with our Key collection sound fx
        this.getKeySfx = new Audio(
            "soundfx/little_robot_sound_factory_fantasy_Pickup_Gold_02.mp3"
        );
        // create new Audio object with our gain an extra life sound fx
        this.extraLifeSfx = new Audio(
            "soundfx/zapsplat_multimedia_game_one_up_extra_life_005.mp3"
        );
    }
}
